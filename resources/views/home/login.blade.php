...
<body data-type="login">
    ...
    <div class="am-g tpl-g">
		...
		<form class="am-form tpl-form-line-form" action="/dologin" method="post">
          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
          <div class="am-form-group">
            <input type="text" name="home_name" class="tpl-form-input" id="user-name" placeholder="请输入用户名"/>
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="am-form-group">
            <input type="password"  name="home_password" class="form-control" placeholder="请输入密码"/>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">    
