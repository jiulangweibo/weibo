...
<script type="text/javascript" charset="utf-8" async="" src="./js/suda.js.下载"></script>
...
<!--
	<form class="am-form tpl-form-border-form tpl-form-border-br" action="/" method="get">
...
-->
<form class="am-form tpl-form-border-form tpl-form-border-br" action="/register/add" method="post" name="myForm">
	<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<div class="W_nologin">
						...
						<div class="W_reg_form">
								...
								<div class="tit"><span class="mobile_ico"></span><i>*</i>邮箱：</div>
									<div class="inp">
										...
										<div class="W_input foreign_tel"><span class="tel_forenum" node-type="mobilesea_txt">0086</span>
											<input type="text" node-type="newmobilesea" action-data="text=请输入您的邮箱" action-type="text_copy" name="email" class="tel_num" value="" autocomplete="off">
										</div>
										</div>
										<div class="attachment">或使用<a node-type="link_regemail" href="#">手机注册</a></div>
									</div>
							...
							<div class="info_list clearfix">
								<div class="tit"><i>*</i>设置密码：</div>
									<div class="inp">
										<input node-type="password" action-data="" action-type="text_copy" name="password" type="password" class="W_input" value="">
									</div>
								...
								<div class="inp">
									<button "action-type="btn_submit" class="W_btn_big" suda-uatrack="key=tblog_register_page&amp;value=register_now_button" refake-type="submit" node-type="btn_submit" name="tijiao" onclick="submitForm()" ><span>点击注册</span></button>
								</form>	
								</div>
								</div>
								<div class="info_list clearfix">
