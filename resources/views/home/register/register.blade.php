...
-->
<form class="am-form tpl-form-border-form tpl-form-border-br" action="/register/add" method="post">
	<input type="hidden" name="_token" value="{{ csrf_token() }}">
					...
					<div class="W_reg_form">
                        ...
                        <div node-type="password_tip" class="tips"></div>
							...
							<input type="hidden" name="c" value="">
								...
								<div class="inp">
									<!--
									<a action-type="btn_submit" class="W_btn_big" suda-uatrack="key=tblog_register_page&amp;value=register_now_button" refake-type="submit" node-type="btn_submit"><span>立即注册</span></a>
									-->
